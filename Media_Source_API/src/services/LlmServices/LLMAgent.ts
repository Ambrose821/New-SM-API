        ...
        try {
            ...
            const config = {
                ...
                properties: {
                    summary: {
                    type: Type.STRING,
                         description: "2 sentences max. Sentence 1: plain-English takeaway with who/what/why. Sentence 2: a single, short debate question (<=12 words). Avoid editorial buzzwords. Use concrete stakes and affected groups. If you cannot complete, respond only with 'NULL'."
                    },
                    headline: {
                    type: Type.STRING,
                     description: "8–12 words. Conversational, no heavy rhetoric. Avoid colons unless necessary. No clichés. If you cannot complete, respond only with 'NULL'."
